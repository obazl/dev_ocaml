...
submodule will be not only preprocessing with a PPX, but also renamed.  The following `aquery` will show this:
...
action 'ppx_transform ocaml_module: demos//ns/topdown/ppx:Red'
  ...
  Command Line: (exec bazel-out/darwin-fastbuild-ST-2386c8310427/bin/ns/topdown/ppx/Red_ppx.sh \
    -o \
    ../bazel-out/darwin-fastbuild-ST-2386c8310427/bin/ns/topdown/ppx/__obazl/Color__Red.ml \
    -impl \
    ns/topdown/ppx/red.ml)

...
(module) dependencies of source files. For example (from [demos/rules/ocaml_archive](https://github.com/obazl/dev_obazl/tree/main/demos/rules/ocaml_archive)):
...
is [codept](https://github.com/Octachron/codept).

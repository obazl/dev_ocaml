...
| deps |  An [OcamlDepset](#ocamldepset) provider.    |
...
<pre>
configure(<a href="#configure-debug">debug</a>, <a href="#configure-switch">switch</a>)
</pre>
...
| :-------------: | :-------------: | :-------------: |
| debug |  enable debugging   |  <code>False</code> |
| switch |  name of OPAM switch to use for builds   |  <code>None</code> |

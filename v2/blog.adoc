...
`module List = Stdlib__List`). The name of the resolver module serves
as the name of the namespace, the entry point to the namespace, as it were.

(What OBazl calls a "resolver" is sometimes called a "mapper" or
"wrapper".)
